...
/** Creates a relay setup for reading updates from an Hbase database*/
public class HbaseRelayFactory extends AbstractRelayFactory implements RelayFactory
{
  ...
  public HbaseRelayFactory(HttpRelay.Config relayConfigBuilder, String[] physicalSourcesConfigFiles)
  {
    super();
  ...
  public HttpRelay createRelay() throws DatabusException
  {
    ...
    {
      throw new DatabusException("HbaseRelay instantiation error: " + ioe.getMessage(), ioe);
    }
  }
