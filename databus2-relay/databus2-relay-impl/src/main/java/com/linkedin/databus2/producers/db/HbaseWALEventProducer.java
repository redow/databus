...
public class HbaseWALEventProducer extends AbstractEventProducer
{
    ...
    ) throws DatabusException
  {
    ...
    for (HbaseWALMonitoredSouceInfo source:sources)
    {
    ...
    _sourceDBEventReader = new HbaseWALEventReader(physicalSourceConfig.getName(), sources,
  ...
  public List<HbaseWALMonitoredSouceInfo> getMonitoredSourceInfos() {
    return (List<HbaseWALMonitoredSouceInfo>)_sourceDBEventReader.getSources();
  }
